...
import finallogica.Interfaz.Registros.*;
...
public class LlenarTabla extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LbTitulo.setText("Panel de prueba");
        ...
        LbDescripcion.setText("Selección de tablas y demás cosas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LlenarTabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LlenarTabla().setVisible(true);
            }
        });
    }
